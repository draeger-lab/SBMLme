...
public interface MEJsonConstants {
  ...
  public static final String processed_protein            =
  ...
  public static final String StoichiometricData           =
    "StoichiometricData";
  ...
  public static final String transcription_data           =
    "transcription_data";
  ...
  public static final String propensity_scaling           =
    "propensity_scaling";
  ...
  public static final String listStoichiometricReferences =
    "listOfStoichiometricReferences";
  public static final String stoichiometricRef            =
    "stoichiometricReference";
  ...
  public static final String listOfSubreactions           =
    "listOfSubreactions";
  // COBRAme GlobalInfo
